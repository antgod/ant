...
使用继承或者decorator/compose包装组件。这样就可以把数据/事件抽象到父组件之中。
  ...
  [1]: http://gitlab.alipay-inc.com/iat/simple-process/blob/master/src/component/SignStep1.jsx
  [2]: http://gitlab.alipay-inc.com/operating_release/morderprod/blob/master/htdocs/templates/signing/screen/signingStepsPage.vm
  [3]: http://gitlab.alipay-inc.com/fengdie-data/morderprod-sp/blob/master/case/caseCenter.vm
  [4]: http://gitlab.alipay-inc.com/fengdie-data/morderprod-sp/blob/master/nav/head/head.vm
  [5]: http://gitlab.alipay-inc.com/merchant-center/simple-process/blob/master/src/composite/Product/MyProductList.jsx
